...
class Chemist(Document):
	"""
		These class possesses operations of Chemist.Chemist can be created,updated.
		below is Workflow for Chemist:
		1.When Chemist is created create his login as website user and accesstype as Chemist
		2.Send Mail with password generated.
		3.Create Profile in solr as provider with type as Chemist
	"""
	def validate(self):
		"""
	...
	def create_user_login(self):
		...
		notify = notify_user({}, args, self.profile_id, send_sms=False, is_provider=True)
