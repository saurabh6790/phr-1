...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "assets/phr/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "assets/phr/css/themes/" + selectedTheme + ".css");
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "assets/phr/images/logo2.png");
					break;

				default:
					$(".navbar-brand img").attr("src", "assets/phr/images/logo.png");
					break;
			};
		};
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "assets/phr/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "assets/phr/images/logo.png");
